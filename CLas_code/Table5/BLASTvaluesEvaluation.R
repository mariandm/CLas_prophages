...
#For ach column of blast change values from factor to numeric
for(col in blast){
...
write.table(t(modified_values[,!modified_values[3,]=="I"]),"./Table5_NewTypevsNewType_coverage.ltx",quote = F,na = " ",row.names = FALSE,sep=" & ")
